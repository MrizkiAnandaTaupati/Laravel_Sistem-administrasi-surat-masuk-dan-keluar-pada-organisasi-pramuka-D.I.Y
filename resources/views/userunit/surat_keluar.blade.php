                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo url("userunit/file_surat_keluar/".$value['no_surat']); ?>" target="_blank">
                            ...
                            <td>
                                <a href="<?php echo url('userunit/surat_keluar/detail_surat_keluar/'.$value['no_surat']) ?>" class="btn btn-sm btn-info text-white">Detail</a>
                            </td>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
