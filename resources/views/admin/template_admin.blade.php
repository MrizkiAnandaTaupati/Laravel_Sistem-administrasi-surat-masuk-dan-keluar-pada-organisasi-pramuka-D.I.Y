            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark shadow" style="background-color:#0B2447" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?php echo url('admin/profil') ?>">
                        ...
                        <div class="collapse" id="submenuDropdown">
                            <ul class="list-unstyled nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo url("admin/sekretariat"); ?>">
                                        <div class="sb-nav-link-icon"><i class="bi bi-file-person-fill"></i></div>
                                        Sekretariat
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo url("admin/sekretaris"); ?>">
                                        <div class="sb-nav-link-icon"><i class="bi bi-person-badge-fill"></i></div>
                                        Sekretaris
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo url("admin/unit"); ?>">
                        ...
                        <a class="nav-link" href="<?php echo url("admin/surat_masuk"); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-envelope-fill"></i></div>
                            Surat Masuk
                        </a>
                        <a class="nav-link" href="<?php echo url("admin/surat_keluar"); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-envelope-paper-fill"></i></div>
                            Surat Keluar
                        </a>
                        <a class="nav-link" href="<?php echo url("admin/notulen"); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-journal-text"></i></div>
                            Notulensi Rapat
                        </a>
                        <a class="nav-link" href="<?php echo url("admin/ringkasan_kegiatan"); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-journal-bookmark"></i></div>
                            Ringkasan Kegiatan
                        </a>
                        <a class="nav-link" href="<?php echo url("admin/arsip"); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-archive-fill"></i></div>
                            Arsip
                        </a>
                        <a class="nav-link" onclick="return confirm('Anda Yakin ?')" href="<?php echo url('admin/logout') ?>">
