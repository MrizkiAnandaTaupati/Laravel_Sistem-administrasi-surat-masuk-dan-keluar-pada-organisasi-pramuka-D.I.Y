...
<div class="container my-5">
    <div class="card p-3 shadow mb-5">
        <div class="card-body">
            <p>Selamat datang <b><?php echo session("nama_admin"); ?>!</b><br>
            Nikmati kemudahan mengelola pengguna, unit, sekretariat, dan data penting lainnya di Panel Manajemen kami. Selamat bekerja efisien dan sukses!
        </div>
    </div>
    <div class="row">
