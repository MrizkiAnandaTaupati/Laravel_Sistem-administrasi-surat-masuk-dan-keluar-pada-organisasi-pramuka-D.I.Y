...
<div class="container">
	<div class="card p-2 mt-5 shadow">
		<div class="card-body">
			<h3 class="fw-bold">Data Arsip Notulen</h3>
			<hr>
		</div>
	</div>
					...
					<tbody>
						<?php foreach ($notulen as $key => $value): ?>
							<tr>
								...
								<td>
									<a href="<?php echo url('admin/arsip_notulen/detail_notulen_arsip/'.$value['id_notulen']) ?>" class="btn-sm btn btn-info text-white">Detail</a>
								</td>
							</tr>
						<?php endforeach ?>
					</tbody>
