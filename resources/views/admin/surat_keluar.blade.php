                ...
                <table class="table table-bordered table-hover" id="tables">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo url('admin/surat_keluar/detail_surat/'.$value['no_surat']) ?>" class="btn btn-sm btn-info text-white">Detail</a>
                            </td>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
                <a href="<?php echo url("admin/surat_keluar/surat_tambah"); ?>" class="btn btn-primary">Tambah</a>
            </div>
        </div>
    </div>
</div>
