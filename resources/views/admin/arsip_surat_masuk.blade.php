...
<div class="container">
    <div class="card shadow p-2 mt-5">
        <div class="card-body">
            <h3 class="fw-bold">Data Arsip Surat Masuk</h3>
            <hr>
        </div>
    </div>
                ...
                <table class="table table-bordered table-hover" id="tables">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $value['posisi_surat']; ?></td>
                            ...
                            <td>
                                <a href="<?php echo url("admin/arsip_surat_masuk/detail_surat_masuk_arsip/".$value['id_surat_masuk']); ?>" class="btn btn-sm btn-info text-white">Detail</a>
                            </td>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
