...
<div class="container">
	<div class="card p-2 mt-5 shadow">
		<div class="card-body">
			<h3 class="fw-bold">Data Arsip Ringkasan Kegiatan</h3>
			<hr>
		</div>
	</div>
					...
					<tbody>
						<?php foreach ($ringkasan_kegiatan as $key => $value): ?>
							<tr>
								...
								<td>
									<a href="<?php echo url('admin/arsip_ringkasan_kegiatan/detail_ringkasan_kegiatan_arsip/'.$value['id_ringkasan_kegiatan']); ?>" class="btn-sm btn btn-info text-white">Detail</a>
								</td>
							</tr>
						<?php endforeach ?>
					</tbody>
