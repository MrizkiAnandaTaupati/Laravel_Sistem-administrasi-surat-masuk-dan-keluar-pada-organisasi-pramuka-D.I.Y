...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color:#0B2447">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">Sekretaris</a>
        <!-- Sidebar Toggle-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark shadow" style="background-color:#0B2447" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?php echo url('sekretaris/dashboard') ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                            Dashboard
                        </a>
                        <a class="nav-link" href="<?php echo url('sekretaris/profil') ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-tag"></i></div>
                            Profil
                        </a>
                        <a class="nav-link" href="<?php echo url("sekretaris/surat_masuk"); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-envelope-fill"></i></div>
                            Surat Masuk
                        </a>
                        <a class="nav-link" href="<?php echo url("sekretaris/surat_keluar"); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-envelope-paper-fill"></i></div>
                            Surat Keluar
                        </a>
                        <a class="nav-link" href="<?php echo url("sekretaris/notulen"); ?>">
                            <div class="sb-nav-link-icon"><i class="bi bi-journal-text"></i></div>
                            Notulensi Rapat
                        </a>
                        <a class="nav-link" onclick="return confirm('Anda Yakin ?')" href="<?php echo url('sekretaris/logout') ?>">
