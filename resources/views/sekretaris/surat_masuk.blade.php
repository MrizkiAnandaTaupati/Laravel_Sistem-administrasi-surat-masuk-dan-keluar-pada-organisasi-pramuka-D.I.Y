                ...
                <table class="table table-bordered table-hover" id="tables">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($value['posisi_surat']=="disposisi"): ?>
                                        <a href="<?php echo url("sekretaris/surat_masuk/disposisi_surat_masuk/".$value['id_surat_masuk']); ?>" class="btn btn-sm btn-info text-white">Disposisi Surat</a>
                                    <?php else: ?>
                                        <a href="<?php echo url("sekretaris/surat_masuk/disposisi_surat_masuk/".$value['id_surat_masuk']); ?>" class="btn btn-sm btn-danger text-white">Isi Disposisi Surat</a>
                                <?php endif?>
                            </td>
                        </tr>
                        <?php endforeach ?>
